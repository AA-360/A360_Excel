...
public final class GetSheetsCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(GetSheetsCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    GetSheets command = new GetSheets();
